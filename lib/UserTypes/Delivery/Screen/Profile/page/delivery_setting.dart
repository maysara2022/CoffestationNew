...
class DeliveryAppSettings extends StatefulWidget {
  const DeliveryAppSettings({Key? key}) : super(key: key);

  @override
  _DeliveryAppSettingsState createState() => _DeliveryAppSettingsState();
}

class _DeliveryAppSettingsState extends State<DeliveryAppSettings> {
