...
class DeliveryStatistics2 extends StatefulWidget {
  const DeliveryStatistics2({Key? key}) : super(key: key);

  @override
  _DeliveryStatistics2State createState() => _DeliveryStatistics2State();
}

class _DeliveryStatistics2State extends State<DeliveryStatistics2> {
