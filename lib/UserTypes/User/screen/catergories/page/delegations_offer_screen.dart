...
class delegationsOfferScreen extends StatefulWidget {
  const delegationsOfferScreen({Key? key}) : super(key: key);

  @override
  _delegationsOfferScreenState createState() => _delegationsOfferScreenState();
}

class _delegationsOfferScreenState extends State<delegationsOfferScreen> {
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                "نحن في كوفيستيشن دائما في خدمتك ونتمنى لك يوما سعيدا",
                style: TextStyle(
                  fontSize: 13,
